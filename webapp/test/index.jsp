...
<head>  
  ...
  <link rel="stylesheet" href="resources/js/calendar/bootstrap_calendar.css" type="text/css" />
  <!--[if lt IE 9]>
    ...
    <header class="bg-white header header-md navbar navbar-fixed-top-xs box-shadow">
      <div class="navbar-header aside-md dk">
        ...
        <a href="/" class="navbar-brand">
          <img src="resources/images/logo.png" class="m-r-sm" alt="scale">
                  ...
                  <div class="dropdown">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                      <span class="thumb avatar pull-left m-r">                        
                        <img src="resources/images/a0.png" class="dker" alt="...">
                      ...
                      <section class="panel b-a">
                        ...
                        <div class="clearfix panel-footer">
                          <div class="input-group">
                            ...
                            <span class="input-group-btn">
                              <button id="submit" type="submit" class="btn btn-default btn-sm btn-rounded"><i class="fa fa-search"></i></button>
                            </span>
                          </div>
                        </div>
                    ...
                    <li class="list-group-item">
                      <div class="media">
                        <span class="pull-left thumb-sm avatar">
                          <img src="resources/images/a3.png" alt="..." class="img-circle">
