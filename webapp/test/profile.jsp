...
<html lang="ko">
  ...
  <![endif]-->
    ...
    <script type="text/javascript" src="http://code.jquery.com/jquery-1.11.3.js"></script>
       ...
       <script src="resources/js/jquery.fileupload2.js?v2"></script>
    ...
    <header class="bg-white header header-md navbar navbar-fixed-top-xs box-shadow">
      <div class="navbar-header aside-md dk">
        ...
        <a href="index.html" class="navbar-brand">
          ...
          <span class="hidden-nav-xs">창대</span>
        </a>
                                ...
                                <div class="inline">
                                  <div class="easypiechart" data-percent="75" data-line-width="6" data-bar-color="#fff" data-track-Color="#2796de" data-scale-Color="false" data-size="140" data-line-cap='butt' data-animate="1000">
                                    <div class="thumb-lg avatar">
                                      <img src="resources/images/a5.png" class="dker">
                                    </div>
                                  </div>
                      ...
                      <div class="wrapper">
                        <section class="panel panel-default">
                          ...
                          <footer class="panel-footer bg-light lter">
                            <button id="submit" class="btn btn-info pull-right btn-sm">POST</button>
                        ...
                        <section class="panel clearfix bg-info dk">
                          <div class="panel-body">
                            <a href="#" class="thumb pull-left m-r">
                              <img src="resources/images/a0.png" class="img-circle b-a b-3x b-white">
                            </a>
                            <div class="clear">
